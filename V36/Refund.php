 ...
 * <li>	主要功能：录入退款数据,提交表单到逻辑处理页面RefundProcess.php</li>
 * <li></li>
 * </ul>
 * 
 * @author <ul>
...
<body>
<form method="post" name="OrderForm" action="RefundProcess.php">
	<div class = "BoxBody">
		...
		<div class="PayForm" >	
			...
			<div class="FormItem">  
				...
				<div class="FormInput"><input type="text" name="Reserved" value="测试退款" ></div>
				<div class="FormRemark"></div>
			</div>
