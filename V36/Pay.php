...
<body>
<form method="post" name="OrderForm" action="PayProcess.php">
	<div class = "BoxBody">
		<div class = "PayHead" >
			<div class = "HeadTitle">网上支付程序示例V3.6 - 普通支付</div>
		</div>
		...
		<div class="PayForm" >	
			...
			<div class="FormItem">  
				...
				<div class="FormInput">
					<select name="BuzType">
						<option value="01">普通支付</option>
					</select>
				</div>
				<div class="FormRemark">01：普通支付</div>
			</div>
			
			<div class="FormItem">  
				<div class="FormLabel">保留域1：</div>
				<div class="FormInput"><input type="text" name="Reserved01" value="保留域1" ></div>
				<div class="FormRemark"></div>
			</div>
			
			<div class="FormItem">  
				<div class="FormLabel">保留域2：</div>
				<div class="FormInput"><input type="text" name="Reserved02" value="保留域2" ></div>
				<div class="FormRemark"></div>
			</div>
