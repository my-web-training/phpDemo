...
Function GetToday(dDate)
    GetToday = RIGHT("0000"+Trim(Year(dDate)),4) & "-" & RIGHT("00"+Trim(Month(dDate)),2) & "-" & RIGHT("00"+Trim(Day(dDate)),2)
End Function
...
<body>
<form method="post" name="OrderForm" action="QueryPayResultProcess.asp">
	<div class = "BoxBody">
		...
		<div class="PayForm" >	
			...
			<div class="FormItem">  
				...
				<div class="FormInput"><input type="text" name="ShoppingTime" value="<%=GetToday(Now) %> 00:00:00" ></div>
